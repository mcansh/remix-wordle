...
describe("computeGuess", () => {
	it.only("works with match and presents", (t) => {
		t.spyOn(gameUtils, "genId", () => "test-id")

		assert.deepEqual<Array<gameUtils.ComputedGuess>>(gameUtils.computeGuess("boost", "basic"), [
			{ letter: "b", state: gameUtils.LetterState.Match, id: "test-id" },
			{ letter: "o", state: gameUtils.LetterState.Miss, id: "test-id" },
			{ letter: "o", state: gameUtils.LetterState.Miss, id: "test-id" },
			{ letter: "s", state: gameUtils.LetterState.Present, id: "test-id" },
			{ letter: "t", state: gameUtils.LetterState.Miss, id: "test-id" },
		])
	})
